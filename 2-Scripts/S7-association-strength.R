...
gamma_df <- readRDS("3-Data/S7-gamma-test.rds")
reconstruction_df <- readRDS("3-Data/S7-pattern-recon.rds")
torus_df <- readRDS("3-Data/S7-torus-trans.rds")
walk_df <- readRDS("3-Data/S7-habitat-random.rds")
...
suppoRt::save_ggplot(plot = gg_gradient, filename = "4-Figures/Fig-S7-1.png", 
                     dpi = dpi, height = height * 0.5, width = width, units = units, 
                     overwrite = FALSE)

suppoRt::save_ggplot(plot = ggplot_correct_total, filename = "4-Figures/Fig-S7-2.png", 
